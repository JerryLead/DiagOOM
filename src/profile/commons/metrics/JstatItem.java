...
public class JstatItem implements Serializable {
	...
	sb.append(String.format(f1, S0U));
	sb.append(' ');
	sb.append(String.format(f1, S1U));
	sb.append(' ');
	sb.append(String.format(f1, EU));
	sb.append(' ');
	sb.append(String.format(f1, OU));
	sb.append(' ');
	sb.append(String.format(f1, PU));
	sb.append(' ');

	sb.append(String.format(f1, S0C));
	sb.append(' ');
	sb.append(String.format(f1, S1C));
	sb.append(' ');
	sb.append(String.format(f1, EC));
	sb.append(' ');
	sb.append(String.format(f1, OC));
	sb.append(' ');
	sb.append(String.format(f1, PC));
	sb.append(' ');
	sb.append(String.format(f1, NGC));
	sb.append(' ');

	sb.append(String.format("%1$-2d", YGC));
	sb.append(' ');
	sb.append(String.format("%1$-2d", FGC));
	sb.append(' ');
	sb.append(String.format("%1$,-3.2f", YGCT));
	sb.append(' ');
	sb.append(String.format("%1$,-3.2f", FGCT));
	sb.append(' ');
